...
class LogBot(irc.IRCClient):
    ...
    nickname = rouletteconfig.nickname
    ...
    lineRate = 2
    channels = []
    channelkey = rouletteconfig.channelkey
...
class LogBotFactory(protocol.ClientFactory):
    ...
    def __init__(self, channel, filename ):
        ...
        self.channelkey = rouletteconfig.channelkey
...
if __name__ == '__main__':
    ...
    f = LogBotFactory(rouletteconfig.channel, rouletteconfig.logfile )
